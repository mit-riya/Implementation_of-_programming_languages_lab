...
%token <NUMBER>  _FLOAT   /* float is a token of type number */
%token <ID> _ID	
%token <NUMBER> _INT
%type <NUMBER> exp factor term

/* define operator precedence, operators defined later have higher precedence */
/* operators are left associative */
%left _ADD _SUB 
%left _MUL _DIV 

%%
prog: _PROGRAM progname _VAR declist _BEGIN stmtlist _END_DOT { 
		if(flag){
